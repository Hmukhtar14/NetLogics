...
public class VariableSyncronizer_AllIUAVariables : BaseNetLogic
{
    ...
    private void RecursiveSearch(IUANode startingNode) 
    {
        ...
        Log.Info(LogicObject.BrowseName, "Adding " + startingNode.BrowseName + " of type " + startingNode.GetType().ToString());
